...
public class Items
{
    ...
    public List<HatofDisguise> HatofDisguises { get; private set; } = new()
    {
        new HatofDisguise(),
    };

    [Description("Teleportation Gun")]
    public List<Tgun> Tguns { get; private set; } = new()
    {
        new Tgun(),
    };
    ...
    public List<Scp500B> SCP500Bs { get; private set; } = new()
    {
        new Scp500B(),
    };
